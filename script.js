...
function detectLanguage(text){
    ...
    const hindiWords = ["hai siggy?","saya baik-baik saja","Apa kabarmu","siapa kamu","javascripts?","ular sanca?","2+2?","pengkodean?","fakta yang menyenangkan?","saran acak?","Apakah saya benar?","Apakah saya cantik","apa itu ritual?","apa yang dimungkinkan oleh ritual?","apa itu ritual","apa yang memungkinkan ritual","apa saja perannya?","mengapa sistem ini diperbarui?","apa yang terjadi pada pemegang peran yang sudah ada?","bagaimana dengan peran npc?","apa yang terjadi dengan peran mage?","mulai dari mana?","apa itu initiate?","apa itu ascendant?","bagaimana cara memeriksa peringkatmu?","apa saja perintah yang berguna di channel?","apa itu ritty bitty","apa itu ritty?","apa itu ritualist?","apa itu radiant ritualist?","apa itu zealot?","apa itu mage?"];
    const koreanWords = ["안녕 시기?","잘 지내요","어떻게 지내세요","누구세요","자바스크립트?","파이썬?","무작위 조언?","내가 맞나요?","내가 아름다워?","리추얼이란 무엇인가요?","리추얼이 가능하게 하는 것은 무엇인가요?","역할은 무엇인가요?","왜 시스템이 개편되었나요?","기존 역할 보유자에게는 어떻게 되나요?","npc 역할은 어떻게 되나요?","mage란 무엇인가요?","어디서 시작하나요?","initiate란 무엇인가요?","ascendant란 무엇인가요?","랭크는 어떻게 확인하나요?","채널에서 유용한 명령어는 무엇인가요?","ritty bitty란 무엇인가요?","ritty란 무엇인가요?","ritualist란 무엇인가요?","radiant ritualist란 무엇인가요?","zealot이란 무엇인가요?","mage란 무엇인가요?"];
...
function siggyResponse(input){
    ...
    for(const key in langQnA){
        if(input.toLowerCase().includes(key)){
            return langQnA[key][0] + " " + langQnA[key][1];
        }
    }
